<div class="container-fluid py-5">
    <div class="container py-5">
        <div class="text-center mx-auto mb-5" style="max-width: 700px;">
            <h1 class="display-4">Sản phẩm đang sale</h1>
            <p>"Sản phẩm đang giảm giá đặc biệt, với mức chiết khấu hấp dẫn!"</p>
        </div>
            ...
            @foreach ($onSaleProducts as $product)
                <div class="border border-primary rounded position-relative vesitable-item">
                    ...
                    <div class="vesitable-img sale-img">
                        <div class="sale-badge"> Giảm {{ $product->discount_percentage }} %</div>
                    ...
                    <div class="p-2 rounded-bottom ">
                        ...
                        <div class="d-flex flex-column justify-content-between ">
                            <p class="text-dark fs-5 fw-bold mb-0"> <span
                                    class="money text-danger">{{ $product->price }}</span>
                                đ/kg</p>
                            <del class="text-dark fs-10 fw-bold mb-0">
                                <span
                                    class="money">{{ $product->price / (1 - $product->discount_percentage / 100) }}</span>
                                đ/kg
                            </del>
                        </div>
